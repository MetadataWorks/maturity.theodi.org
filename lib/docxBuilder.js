...
async function generateDocxReport(projectData,owner) {
    ...
    const filePath = "./private/assessments/ODM2024.docx";
    if (checkFileExists(filePath)) {
        try {
            const { path: tempFilePath } = await tmp.file();
            const doc = await patchDocument(fs.readFileSync("./private/assessments/ODM2024.docx"), {
